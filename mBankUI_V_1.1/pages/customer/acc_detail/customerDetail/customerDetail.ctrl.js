...
var scotchApp = angular.module('app.customerDetails', ['ngRoute'])


scotchApp.controller('customerDetailsController', function ($rootScope, $scope, $http, $routeParams, $location, $filter, $cookieStore) {
