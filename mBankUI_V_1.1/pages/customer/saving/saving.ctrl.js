...
var scotchApp = angular.module('app.saving', ['ngRoute', 'ngCookies'])


scotchApp.controller('savingController', function ($rootScope, $interval, $timeout, $scope, $http, $routeParams, $location, $filter, $cookieStore) {
