...
var scotchApp = angular.module('app.customerPersonalDetails', ['ngRoute'])


scotchApp.controller('customerPersonalDetailsController', function ($rootScope, $scope, $http, $routeParams, $location, $filter, $cookieStore) {
