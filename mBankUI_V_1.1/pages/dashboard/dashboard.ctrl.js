...
var scotchApp = angular.module('app.dashboard', ['ngRoute', 'ngCookies'])


scotchApp.controller('dashboardController', function ($rootScope, $interval, $timeout, $scope, $http, $routeParams, $location, $filter, $cookieStore) {
